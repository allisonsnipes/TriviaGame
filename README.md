...
* In your `javascript` folder, create an `app.js` file; here you'll write all of your JavaScript and jQuery.ww
* In your `images` folder, save whatever images you'd like to use in this exercise.

6. You can also skip steps 2-5 by using [JK's Homework Boilerplate code](https://github.com/drukelly/BCS-HW-Starter-Template.)

7. Choose a game to build from your options below. 
